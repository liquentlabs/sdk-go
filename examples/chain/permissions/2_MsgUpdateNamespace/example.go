...
func main() {
	...
	policy_manager_capability := permissionstypes.PolicyManagerCapability{
		Manager:    "lqt1policymanageraddress",
	...
	msg := &permissionstypes.MsgUpdateNamespace{
		...
		Denom:                     denom,
		ContractHook:              &permissionstypes.MsgUpdateNamespace_SetContractHook{NewValue: "lqt19ld6swyldyujcn72j7ugnu9twafhs9wxlyye5m"},
