...
import (
	...
	peggytypes "github.com/liquentlabs/sdk-go/chain/peggy/types"
...
func main() {
	...
	amount := sdktypes.Coin{
		Denom: "lqt", Amount: math.NewInt(5000000000000000000), // 5 LQT
	}
	bridgeFee := sdktypes.Coin{
		Denom: "lqt", Amount: math.NewInt(2000000000000000000), // 2 LQT
	}
