...
func main() {
	...
	firstAmount := 69
	firstToken := "factory/lqt1hdvy6tl89llqy3ze8lv6mz5qh66sx9enn0jxg6/lqt12ngevx045zpvacus9s6anr258gkwpmthnz80e9"
	secondAmount := 420
	...
	message := wasmxtypes.MsgExecuteContractCompat{
		...
		Contract: "lqt1ady3s7whq30l4fx8sj3x6muv5mx4dfdlcpv8n7",
		Msg:      "{\"increment\": {}}",
		Funds:    funds,
	}
