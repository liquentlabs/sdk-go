...
```bash
$ git clone git@github.com:liquentlabs/sdk-go.git
$ cd sdk-go
$ go mod download
```
...
liquentd keys unsafe-import-eth-key lqt-user 5d386fbdbf11f1141010f81a46b40f94887367562bd33b452bbaa6ce1cd1381e
...
The SDK provides two different clients for interacting with the Liquent Exchange:
...
(you have to clone [this repo](https://github.com/liquentlabs/liquent-indexer) into `../liquent-indexer`)
