...
import (
	...
	"github.com/liquentlabs/sdk-go/chain/crypto/ethsecp256k1"
)
...
var (
	// SupportedAlgorithms defines the list of signing algorithms used on Liquent:
	//  - eth_secp256k1 (Ethereum)
	//  - secp256k1 (Tendermint)
	SupportedAlgorithms = keyring.SigningAlgoList{EthSecp256k1, hd.Secp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Liquent for the Ledger device:
	//  - eth_secp256k1 (Ethereum)
	//  - secp256k1 (Tendermint)
