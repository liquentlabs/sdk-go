...
// source: liquent/permissions/v1beta1/permissions.proto
...
type PolicyStatus struct {
	Action     Action `protobuf:"varint,1,opt,name=action,proto3,enum=liquent.permissions.v1beta1.Action" json:"action,omitempty"`
...
type PolicyManagerCapability struct {
	Manager    string `protobuf:"bytes,1,opt,name=manager,proto3" json:"manager,omitempty"`
	Action     Action `protobuf:"varint,2,opt,name=action,proto3,enum=liquent.permissions.v1beta1.Action" json:"action,omitempty"`
...
func init() {
	proto.RegisterEnum("liquent.permissions.v1beta1.Action", Action_name, Action_value)
	proto.RegisterType((*Namespace)(nil), "liquent.permissions.v1beta1.Namespace")
	proto.RegisterType((*ActorRoles)(nil), "liquent.permissions.v1beta1.ActorRoles")
	proto.RegisterType((*RoleActors)(nil), "liquent.permissions.v1beta1.RoleActors")
	proto.RegisterType((*RoleManager)(nil), "liquent.permissions.v1beta1.RoleManager")
	proto.RegisterType((*PolicyStatus)(nil), "liquent.permissions.v1beta1.PolicyStatus")
	proto.RegisterType((*Role)(nil), "liquent.permissions.v1beta1.Role")
	proto.RegisterType((*PolicyManagerCapability)(nil), "liquent.permissions.v1beta1.PolicyManagerCapability")
	proto.RegisterType((*RoleIDs)(nil), "liquent.permissions.v1beta1.RoleIDs")
	proto.RegisterType((*AddressVoucher)(nil), "liquent.permissions.v1beta1.AddressVoucher")
}

func init() {
	proto.RegisterFile("liquent/permissions/v1beta1/permissions.proto", fileDescriptor_6d25f3ecf3806c6c)
}
