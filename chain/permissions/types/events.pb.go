...
// source: liquent/permissions/v1beta1/events.proto
...
func init() {
	proto.RegisterType((*EventSetVoucher)(nil), "liquent.permissions.v1beta1.EventSetVoucher")
}

func init() {
	proto.RegisterFile("liquent/permissions/v1beta1/events.proto", fileDescriptor_705c3e21b20426fa)
}
