...
// source: liquent/permissions/v1beta1/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "liquent.permissions.v1beta1.Params")
}

func init() {
	proto.RegisterFile("liquent/permissions/v1beta1/params.proto", fileDescriptor_4a7ea0496163621f)
}
