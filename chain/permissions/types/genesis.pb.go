...
// source: liquent/permissions/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "liquent.permissions.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("liquent/permissions/v1beta1/genesis.proto", fileDescriptor_5ff1982ce1793022)
}
