...
// source: liquent/types/v1beta1/tx_response.proto
...
func init() {
	proto.RegisterType((*TxResponseGenericMessage)(nil), "liquent.types.v1beta1.TxResponseGenericMessage")
	proto.RegisterType((*TxResponseData)(nil), "liquent.types.v1beta1.TxResponseData")
}

func init() {
	proto.RegisterFile("liquent/types/v1beta1/tx_response.proto", fileDescriptor_9122428102320deb)
}
