...
// source: liquent/oracle/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "liquent.oracle.v1beta1.GenesisState")
	proto.RegisterType((*CalldataRecord)(nil), "liquent.oracle.v1beta1.CalldataRecord")
}

func init() {
	proto.RegisterFile("liquent/oracle/v1beta1/genesis.proto", fileDescriptor_f7e14cf80151b4d2)
}
