...
// source: liquent/peggy/v1/types.proto
...
func init() {
	proto.RegisterType((*BridgeValidator)(nil), "liquent.peggy.v1.BridgeValidator")
	proto.RegisterType((*Valset)(nil), "liquent.peggy.v1.Valset")
	proto.RegisterType((*LastObservedEthereumBlockHeight)(nil), "liquent.peggy.v1.LastObservedEthereumBlockHeight")
	proto.RegisterType((*LastClaimEvent)(nil), "liquent.peggy.v1.LastClaimEvent")
	proto.RegisterType((*ERC20ToDenom)(nil), "liquent.peggy.v1.ERC20ToDenom")
}

func init() { proto.RegisterFile("liquent/peggy/v1/types.proto", fileDescriptor_b641943ad411b503) }
