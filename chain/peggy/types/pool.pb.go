...
// source: liquent/peggy/v1/pool.proto
...
func init() {
	proto.RegisterType((*IDSet)(nil), "liquent.peggy.v1.IDSet")
	proto.RegisterType((*BatchFees)(nil), "liquent.peggy.v1.BatchFees")
}

func init() { proto.RegisterFile("liquent/peggy/v1/pool.proto", fileDescriptor_36397d69759ce164) }
