...
// source: liquent/peggy/v1/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "liquent.peggy.v1.Params")
}

func init() { proto.RegisterFile("liquent/peggy/v1/params.proto", fileDescriptor_f21ffdf8d29783da) }
