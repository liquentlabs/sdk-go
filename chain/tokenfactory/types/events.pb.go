...
// source: liquent/tokenfactory/v1beta1/events.proto
...
func init() {
	proto.RegisterType((*EventCreateDenom)(nil), "liquent.tokenfactory.v1beta1.EventCreateDenom")
	proto.RegisterType((*EventMint)(nil), "liquent.tokenfactory.v1beta1.EventMint")
	proto.RegisterType((*EventBurn)(nil), "liquent.tokenfactory.v1beta1.EventBurn")
	proto.RegisterType((*EventChangeAdmin)(nil), "liquent.tokenfactory.v1beta1.EventChangeAdmin")
	proto.RegisterType((*EventSetDenomMetadata)(nil), "liquent.tokenfactory.v1beta1.EventSetDenomMetadata")
}

func init() {
	proto.RegisterFile("liquent/tokenfactory/v1beta1/events.proto", fileDescriptor_b9fd0c5434c2a5b7)
}
