...
// source: liquent/insurance/v1beta1/events.proto
...
func init() {
	proto.RegisterType((*EventInsuranceFundUpdate)(nil), "liquent.insurance.v1beta1.EventInsuranceFundUpdate")
	proto.RegisterType((*EventRequestRedemption)(nil), "liquent.insurance.v1beta1.EventRequestRedemption")
	proto.RegisterType((*EventWithdrawRedemption)(nil), "liquent.insurance.v1beta1.EventWithdrawRedemption")
	proto.RegisterType((*EventUnderwrite)(nil), "liquent.insurance.v1beta1.EventUnderwrite")
	proto.RegisterType((*EventInsuranceWithdraw)(nil), "liquent.insurance.v1beta1.EventInsuranceWithdraw")
}

func init() {
	proto.RegisterFile("liquent/insurance/v1beta1/events.proto", fileDescriptor_238c43c591e30770)
}
