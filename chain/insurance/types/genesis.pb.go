...
// source: liquent/insurance/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "liquent.insurance.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("liquent/insurance/v1beta1/genesis.proto", fileDescriptor_293324fee7d3f3b1)
}
