...
// source: liquent/insurance/v1beta1/insurance.proto
...
type InsuranceFund struct {
	...
	OracleType types.OracleType `protobuf:"varint,10,opt,name=oracle_type,json=oracleType,proto3,enum=liquent.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
...
func init() {
	proto.RegisterType((*Params)(nil), "liquent.insurance.v1beta1.Params")
	proto.RegisterType((*InsuranceFund)(nil), "liquent.insurance.v1beta1.InsuranceFund")
	proto.RegisterType((*RedemptionSchedule)(nil), "liquent.insurance.v1beta1.RedemptionSchedule")
}

func init() {
	proto.RegisterFile("liquent/insurance/v1beta1/insurance.proto", fileDescriptor_dbc47a7b76393948)
}
