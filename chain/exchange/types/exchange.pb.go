...
// source: liquent/exchange/v1beta1/exchange.proto
...
type Params struct {
	...
	AtomicMarketOrderAccessLevel AtomicMarketOrderAccessLevel `protobuf:"varint,19,opt,name=atomic_market_order_access_level,json=atomicMarketOrderAccessLevel,proto3,enum=liquent.exchange.v1beta1.AtomicMarketOrderAccessLevel" json:"atomic_market_order_access_level,omitempty"`
...
// An object describing a derivative market in the Liquent Futures Protocol.
type DerivativeMarket struct {
	...
	// Oracle type
	OracleType types1.OracleType `protobuf:"varint,4,opt,name=oracle_type,json=oracleType,proto3,enum=liquent.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
	...
	Status MarketStatus `protobuf:"varint,14,opt,name=status,proto3,enum=liquent.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
// An object describing a binary options market in Liquent Protocol.
...
type SpotMarket struct {
	...
	MarketId string `protobuf:"bytes,7,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	// Status of the market
	Status MarketStatus `protobuf:"varint,8,opt,name=status,proto3,enum=liquent.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
type SpotOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,3,opt,name=order_type,json=orderType,proto3,enum=liquent.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
...
type SpotLimitOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,2,opt,name=order_type,json=orderType,proto3,enum=liquent.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
...
type SpotMarketOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,4,opt,name=order_type,json=orderType,proto3,enum=liquent.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
	// trigger_price is the trigger price used by stop/take orders
...
func init() {
	proto.RegisterEnum("liquent.exchange.v1beta1.AtomicMarketOrderAccessLevel", AtomicMarketOrderAccessLevel_name, AtomicMarketOrderAccessLevel_value)
	proto.RegisterEnum("liquent.exchange.v1beta1.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterEnum("liquent.exchange.v1beta1.OrderType", OrderType_name, OrderType_value)
	proto.RegisterEnum("liquent.exchange.v1beta1.ExecutionType", ExecutionType_name, ExecutionType_value)
	proto.RegisterEnum("liquent.exchange.v1beta1.OrderMask", OrderMask_name, OrderMask_value)
	proto.RegisterType((*Params)(nil), "liquent.exchange.v1beta1.Params")
	proto.RegisterType((*MarketFeeMultiplier)(nil), "liquent.exchange.v1beta1.MarketFeeMultiplier")
	proto.RegisterType((*DerivativeMarket)(nil), "liquent.exchange.v1beta1.DerivativeMarket")
	proto.RegisterType((*BinaryOptionsMarket)(nil), "liquent.exchange.v1beta1.BinaryOptionsMarket")
	proto.RegisterType((*ExpiryFuturesMarketInfo)(nil), "liquent.exchange.v1beta1.ExpiryFuturesMarketInfo")
	proto.RegisterType((*PerpetualMarketInfo)(nil), "liquent.exchange.v1beta1.PerpetualMarketInfo")
	proto.RegisterType((*PerpetualMarketFunding)(nil), "liquent.exchange.v1beta1.PerpetualMarketFunding")
	proto.RegisterType((*DerivativeMarketSettlementInfo)(nil), "liquent.exchange.v1beta1.DerivativeMarketSettlementInfo")
	proto.RegisterType((*NextFundingTimestamp)(nil), "liquent.exchange.v1beta1.NextFundingTimestamp")
	proto.RegisterType((*MidPriceAndTOB)(nil), "liquent.exchange.v1beta1.MidPriceAndTOB")
	proto.RegisterType((*SpotMarket)(nil), "liquent.exchange.v1beta1.SpotMarket")
	proto.RegisterType((*Deposit)(nil), "liquent.exchange.v1beta1.Deposit")
	proto.RegisterType((*SubaccountTradeNonce)(nil), "liquent.exchange.v1beta1.SubaccountTradeNonce")
	proto.RegisterType((*OrderInfo)(nil), "liquent.exchange.v1beta1.OrderInfo")
	proto.RegisterType((*SpotOrder)(nil), "liquent.exchange.v1beta1.SpotOrder")
	proto.RegisterType((*SpotLimitOrder)(nil), "liquent.exchange.v1beta1.SpotLimitOrder")
	proto.RegisterType((*SpotMarketOrder)(nil), "liquent.exchange.v1beta1.SpotMarketOrder")
	proto.RegisterType((*DerivativeOrder)(nil), "liquent.exchange.v1beta1.DerivativeOrder")
	proto.RegisterType((*SubaccountOrderbookMetadata)(nil), "liquent.exchange.v1beta1.SubaccountOrderbookMetadata")
	proto.RegisterType((*SubaccountOrder)(nil), "liquent.exchange.v1beta1.SubaccountOrder")
	proto.RegisterType((*SubaccountOrderData)(nil), "liquent.exchange.v1beta1.SubaccountOrderData")
	proto.RegisterType((*DerivativeLimitOrder)(nil), "liquent.exchange.v1beta1.DerivativeLimitOrder")
	proto.RegisterType((*DerivativeMarketOrder)(nil), "liquent.exchange.v1beta1.DerivativeMarketOrder")
	proto.RegisterType((*Position)(nil), "liquent.exchange.v1beta1.Position")
	proto.RegisterType((*MarketOrderIndicator)(nil), "liquent.exchange.v1beta1.MarketOrderIndicator")
	proto.RegisterType((*TradeLog)(nil), "liquent.exchange.v1beta1.TradeLog")
	proto.RegisterType((*PositionDelta)(nil), "liquent.exchange.v1beta1.PositionDelta")
	proto.RegisterType((*DerivativeTradeLog)(nil), "liquent.exchange.v1beta1.DerivativeTradeLog")
	proto.RegisterType((*SubaccountPosition)(nil), "liquent.exchange.v1beta1.SubaccountPosition")
	proto.RegisterType((*SubaccountDeposit)(nil), "liquent.exchange.v1beta1.SubaccountDeposit")
	proto.RegisterType((*DepositUpdate)(nil), "liquent.exchange.v1beta1.DepositUpdate")
	proto.RegisterType((*PointsMultiplier)(nil), "liquent.exchange.v1beta1.PointsMultiplier")
	proto.RegisterType((*TradingRewardCampaignBoostInfo)(nil), "liquent.exchange.v1beta1.TradingRewardCampaignBoostInfo")
	proto.RegisterType((*CampaignRewardPool)(nil), "liquent.exchange.v1beta1.CampaignRewardPool")
	proto.RegisterType((*TradingRewardCampaignInfo)(nil), "liquent.exchange.v1beta1.TradingRewardCampaignInfo")
	proto.RegisterType((*FeeDiscountTierInfo)(nil), "liquent.exchange.v1beta1.FeeDiscountTierInfo")
	proto.RegisterType((*FeeDiscountSchedule)(nil), "liquent.exchange.v1beta1.FeeDiscountSchedule")
	proto.RegisterType((*FeeDiscountTierTTL)(nil), "liquent.exchange.v1beta1.FeeDiscountTierTTL")
	proto.RegisterType((*VolumeRecord)(nil), "liquent.exchange.v1beta1.VolumeRecord")
	proto.RegisterType((*AccountRewards)(nil), "liquent.exchange.v1beta1.AccountRewards")
	proto.RegisterType((*TradeRecords)(nil), "liquent.exchange.v1beta1.TradeRecords")
	proto.RegisterType((*SubaccountIDs)(nil), "liquent.exchange.v1beta1.SubaccountIDs")
	proto.RegisterType((*TradeRecord)(nil), "liquent.exchange.v1beta1.TradeRecord")
	proto.RegisterType((*Level)(nil), "liquent.exchange.v1beta1.Level")
	proto.RegisterType((*AggregateSubaccountVolumeRecord)(nil), "liquent.exchange.v1beta1.AggregateSubaccountVolumeRecord")
	proto.RegisterType((*AggregateAccountVolumeRecord)(nil), "liquent.exchange.v1beta1.AggregateAccountVolumeRecord")
	proto.RegisterType((*MarketVolume)(nil), "liquent.exchange.v1beta1.MarketVolume")
	proto.RegisterType((*DenomDecimals)(nil), "liquent.exchange.v1beta1.DenomDecimals")
	proto.RegisterType((*GrantAuthorization)(nil), "liquent.exchange.v1beta1.GrantAuthorization")
	proto.RegisterType((*ActiveGrant)(nil), "liquent.exchange.v1beta1.ActiveGrant")
	proto.RegisterType((*EffectiveGrant)(nil), "liquent.exchange.v1beta1.EffectiveGrant")
	proto.RegisterType((*DenomMinNotional)(nil), "liquent.exchange.v1beta1.DenomMinNotional")
}

func init() {
	proto.RegisterFile("liquent/exchange/v1beta1/exchange.proto", fileDescriptor_2116e2804e9c53f9)
}
