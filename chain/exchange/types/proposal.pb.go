...
// source: liquent/exchange/v1beta1/proposal.proto
...
type SpotMarketParamUpdateProposal struct {
	...
	Status              MarketStatus                 `protobuf:"varint,9,opt,name=status,proto3,enum=liquent.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
type ExchangeEnableProposal struct {
	Title        string       `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description  string       `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	ExchangeType ExchangeType `protobuf:"varint,3,opt,name=exchangeType,proto3,enum=liquent.exchange.v1beta1.ExchangeType" json:"exchangeType,omitempty"`
}
...
type PerpetualMarketLaunchProposal struct {
	...
	// Oracle type
	OracleType types.OracleType `protobuf:"varint,8,opt,name=oracle_type,json=oracleType,proto3,enum=liquent.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
...
type BinaryOptionsMarketLaunchProposal struct {
	...
	// Oracle type
	OracleType types.OracleType `protobuf:"varint,6,opt,name=oracle_type,json=oracleType,proto3,enum=liquent.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
	// Scale factor for oracle prices.
	OracleScaleFactor uint32 `protobuf:"varint,7,opt,name=oracle_scale_factor,json=oracleScaleFactor,proto3" json:"oracle_scale_factor,omitempty"`
...
type DerivativeMarketParamUpdateProposal struct {
	...
	Status               MarketStatus                 `protobuf:"varint,13,opt,name=status,proto3,enum=liquent.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
type ProviderOracleParams struct {
	...
	// Oracle type
	OracleType types.OracleType `protobuf:"varint,4,opt,name=oracle_type,json=oracleType,proto3,enum=liquent.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("liquent.exchange.v1beta1.ExchangeType", ExchangeType_name, ExchangeType_value)
	proto.RegisterType((*SpotMarketParamUpdateProposal)(nil), "liquent.exchange.v1beta1.SpotMarketParamUpdateProposal")
	proto.RegisterType((*ExchangeEnableProposal)(nil), "liquent.exchange.v1beta1.ExchangeEnableProposal")
	proto.RegisterType((*BatchExchangeModificationProposal)(nil), "liquent.exchange.v1beta1.BatchExchangeModificationProposal")
	proto.RegisterType((*SpotMarketLaunchProposal)(nil), "liquent.exchange.v1beta1.SpotMarketLaunchProposal")
	proto.RegisterType((*PerpetualMarketLaunchProposal)(nil), "liquent.exchange.v1beta1.PerpetualMarketLaunchProposal")
	proto.RegisterType((*BinaryOptionsMarketLaunchProposal)(nil), "liquent.exchange.v1beta1.BinaryOptionsMarketLaunchProposal")
	proto.RegisterType((*ExpiryFuturesMarketLaunchProposal)(nil), "liquent.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal")
	proto.RegisterType((*DerivativeMarketParamUpdateProposal)(nil), "liquent.exchange.v1beta1.DerivativeMarketParamUpdateProposal")
	proto.RegisterType((*AdminInfo)(nil), "liquent.exchange.v1beta1.AdminInfo")
	proto.RegisterType((*MarketForcedSettlementProposal)(nil), "liquent.exchange.v1beta1.MarketForcedSettlementProposal")
	proto.RegisterType((*UpdateDenomDecimalsProposal)(nil), "liquent.exchange.v1beta1.UpdateDenomDecimalsProposal")
	proto.RegisterType((*BinaryOptionsMarketParamUpdateProposal)(nil), "liquent.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal")
	proto.RegisterType((*ProviderOracleParams)(nil), "liquent.exchange.v1beta1.ProviderOracleParams")
	proto.RegisterType((*OracleParams)(nil), "liquent.exchange.v1beta1.OracleParams")
	proto.RegisterType((*TradingRewardCampaignLaunchProposal)(nil), "liquent.exchange.v1beta1.TradingRewardCampaignLaunchProposal")
	proto.RegisterType((*TradingRewardCampaignUpdateProposal)(nil), "liquent.exchange.v1beta1.TradingRewardCampaignUpdateProposal")
	proto.RegisterType((*RewardPointUpdate)(nil), "liquent.exchange.v1beta1.RewardPointUpdate")
	proto.RegisterType((*TradingRewardPendingPointsUpdateProposal)(nil), "liquent.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal")
	proto.RegisterType((*FeeDiscountProposal)(nil), "liquent.exchange.v1beta1.FeeDiscountProposal")
	proto.RegisterType((*BatchCommunityPoolSpendProposal)(nil), "liquent.exchange.v1beta1.BatchCommunityPoolSpendProposal")
	proto.RegisterType((*AtomicMarketOrderFeeMultiplierScheduleProposal)(nil), "liquent.exchange.v1beta1.AtomicMarketOrderFeeMultiplierScheduleProposal")
	proto.RegisterType((*DenomMinNotionalProposal)(nil), "liquent.exchange.v1beta1.DenomMinNotionalProposal")
}

func init() {
	proto.RegisterFile("liquent/exchange/v1beta1/proposal.proto", fileDescriptor_32e9ec9b6b22477c)
}
