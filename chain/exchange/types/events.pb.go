...
// source: liquent/exchange/v1beta1/events.proto
...
type EventBatchSpotExecution struct {
	...
	ExecutionType ExecutionType `protobuf:"varint,3,opt,name=executionType,proto3,enum=liquent.exchange.v1beta1.ExecutionType" json:"executionType,omitempty"`
...
type EventBatchDerivativeExecution struct {
	...
	ExecutionType     ExecutionType                `protobuf:"varint,5,opt,name=executionType,proto3,enum=liquent.exchange.v1beta1.ExecutionType" json:"executionType,omitempty"`
...
func init() {
	proto.RegisterType((*EventBatchSpotExecution)(nil), "liquent.exchange.v1beta1.EventBatchSpotExecution")
	proto.RegisterType((*EventBatchDerivativeExecution)(nil), "liquent.exchange.v1beta1.EventBatchDerivativeExecution")
	proto.RegisterType((*EventLostFundsFromLiquidation)(nil), "liquent.exchange.v1beta1.EventLostFundsFromLiquidation")
	proto.RegisterType((*EventBatchDerivativePosition)(nil), "liquent.exchange.v1beta1.EventBatchDerivativePosition")
	proto.RegisterType((*EventDerivativeMarketPaused)(nil), "liquent.exchange.v1beta1.EventDerivativeMarketPaused")
	proto.RegisterType((*EventSettledMarketBalance)(nil), "liquent.exchange.v1beta1.EventSettledMarketBalance")
	proto.RegisterType((*EventNotSettledMarketBalance)(nil), "liquent.exchange.v1beta1.EventNotSettledMarketBalance")
	proto.RegisterType((*EventMarketBeyondBankruptcy)(nil), "liquent.exchange.v1beta1.EventMarketBeyondBankruptcy")
	proto.RegisterType((*EventAllPositionsHaircut)(nil), "liquent.exchange.v1beta1.EventAllPositionsHaircut")
	proto.RegisterType((*EventBinaryOptionsMarketUpdate)(nil), "liquent.exchange.v1beta1.EventBinaryOptionsMarketUpdate")
	proto.RegisterType((*EventNewSpotOrders)(nil), "liquent.exchange.v1beta1.EventNewSpotOrders")
	proto.RegisterType((*EventNewDerivativeOrders)(nil), "liquent.exchange.v1beta1.EventNewDerivativeOrders")
	proto.RegisterType((*EventCancelSpotOrder)(nil), "liquent.exchange.v1beta1.EventCancelSpotOrder")
	proto.RegisterType((*EventSpotMarketUpdate)(nil), "liquent.exchange.v1beta1.EventSpotMarketUpdate")
	proto.RegisterType((*EventPerpetualMarketUpdate)(nil), "liquent.exchange.v1beta1.EventPerpetualMarketUpdate")
	proto.RegisterType((*EventExpiryFuturesMarketUpdate)(nil), "liquent.exchange.v1beta1.EventExpiryFuturesMarketUpdate")
	proto.RegisterType((*EventPerpetualMarketFundingUpdate)(nil), "liquent.exchange.v1beta1.EventPerpetualMarketFundingUpdate")
	proto.RegisterType((*EventSubaccountDeposit)(nil), "liquent.exchange.v1beta1.EventSubaccountDeposit")
	proto.RegisterType((*EventSubaccountWithdraw)(nil), "liquent.exchange.v1beta1.EventSubaccountWithdraw")
	proto.RegisterType((*EventSubaccountBalanceTransfer)(nil), "liquent.exchange.v1beta1.EventSubaccountBalanceTransfer")
	proto.RegisterType((*EventBatchDepositUpdate)(nil), "liquent.exchange.v1beta1.EventBatchDepositUpdate")
	proto.RegisterType((*DerivativeMarketOrderCancel)(nil), "liquent.exchange.v1beta1.DerivativeMarketOrderCancel")
	proto.RegisterType((*EventCancelDerivativeOrder)(nil), "liquent.exchange.v1beta1.EventCancelDerivativeOrder")
	proto.RegisterType((*EventFeeDiscountSchedule)(nil), "liquent.exchange.v1beta1.EventFeeDiscountSchedule")
	proto.RegisterType((*EventTradingRewardCampaignUpdate)(nil), "liquent.exchange.v1beta1.EventTradingRewardCampaignUpdate")
	proto.RegisterType((*EventTradingRewardDistribution)(nil), "liquent.exchange.v1beta1.EventTradingRewardDistribution")
	proto.RegisterType((*EventNewConditionalDerivativeOrder)(nil), "liquent.exchange.v1beta1.EventNewConditionalDerivativeOrder")
	proto.RegisterType((*EventCancelConditionalDerivativeOrder)(nil), "liquent.exchange.v1beta1.EventCancelConditionalDerivativeOrder")
	proto.RegisterType((*EventConditionalDerivativeOrderTrigger)(nil), "liquent.exchange.v1beta1.EventConditionalDerivativeOrderTrigger")
	proto.RegisterType((*EventOrderFail)(nil), "liquent.exchange.v1beta1.EventOrderFail")
	proto.RegisterType((*EventAtomicMarketOrderFeeMultipliersUpdated)(nil), "liquent.exchange.v1beta1.EventAtomicMarketOrderFeeMultipliersUpdated")
	proto.RegisterType((*EventOrderbookUpdate)(nil), "liquent.exchange.v1beta1.EventOrderbookUpdate")
	proto.RegisterType((*OrderbookUpdate)(nil), "liquent.exchange.v1beta1.OrderbookUpdate")
	proto.RegisterType((*Orderbook)(nil), "liquent.exchange.v1beta1.Orderbook")
	proto.RegisterType((*EventGrantAuthorizations)(nil), "liquent.exchange.v1beta1.EventGrantAuthorizations")
	proto.RegisterType((*EventGrantActivation)(nil), "liquent.exchange.v1beta1.EventGrantActivation")
	proto.RegisterType((*EventInvalidGrant)(nil), "liquent.exchange.v1beta1.EventInvalidGrant")
	proto.RegisterType((*EventOrderCancelFail)(nil), "liquent.exchange.v1beta1.EventOrderCancelFail")
}

func init() {
	proto.RegisterFile("liquent/exchange/v1beta1/events.proto", fileDescriptor_20dda602b6b13fd3)
}
