...
// source: liquent/exchange/v2/orderbook.proto
...
func init() {
	proto.RegisterType((*SpotOrderBook)(nil), "liquent.exchange.v2.SpotOrderBook")
	proto.RegisterType((*DerivativeOrderBook)(nil), "liquent.exchange.v2.DerivativeOrderBook")
	proto.RegisterType((*ConditionalDerivativeOrderBook)(nil), "liquent.exchange.v2.ConditionalDerivativeOrderBook")
	proto.RegisterType((*SubaccountOrderbookMetadata)(nil), "liquent.exchange.v2.SubaccountOrderbookMetadata")
}

func init() {
	proto.RegisterFile("liquent/exchange/v2/orderbook.proto", fileDescriptor_d2fb0f56aadb9282)
}
