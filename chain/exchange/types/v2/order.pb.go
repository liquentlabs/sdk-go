...
// source: liquent/exchange/v2/order.proto
...
type SpotOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,3,opt,name=order_type,json=orderType,proto3,enum=liquent.exchange.v2.OrderType" json:"order_type,omitempty"`
...
type SpotMarketOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,4,opt,name=order_type,json=orderType,proto3,enum=liquent.exchange.v2.OrderType" json:"order_type,omitempty"`
...
type SpotLimitOrder struct {
	...
	OrderInfo OrderInfo `protobuf:"bytes,1,opt,name=order_info,json=orderInfo,proto3" json:"order_info"`
	// order types
	OrderType OrderType `protobuf:"varint,2,opt,name=order_type,json=orderType,proto3,enum=liquent.exchange.v2.OrderType" json:"order_type,omitempty"`
...
func init() {
	proto.RegisterEnum("liquent.exchange.v2.OrderType", OrderType_name, OrderType_value)
	proto.RegisterEnum("liquent.exchange.v2.OrderMask", OrderMask_name, OrderMask_value)
	proto.RegisterEnum("liquent.exchange.v2.AtomicMarketOrderAccessLevel", AtomicMarketOrderAccessLevel_name, AtomicMarketOrderAccessLevel_value)
	proto.RegisterType((*OrderInfo)(nil), "liquent.exchange.v2.OrderInfo")
	proto.RegisterType((*SpotOrder)(nil), "liquent.exchange.v2.SpotOrder")
	proto.RegisterType((*SpotMarketOrder)(nil), "liquent.exchange.v2.SpotMarketOrder")
	proto.RegisterType((*SpotLimitOrder)(nil), "liquent.exchange.v2.SpotLimitOrder")
	proto.RegisterType((*DerivativeOrder)(nil), "liquent.exchange.v2.DerivativeOrder")
	proto.RegisterType((*DerivativeMarketOrder)(nil), "liquent.exchange.v2.DerivativeMarketOrder")
	proto.RegisterType((*DerivativeLimitOrder)(nil), "liquent.exchange.v2.DerivativeLimitOrder")
}

func init() { proto.RegisterFile("liquent/exchange/v2/order.proto", fileDescriptor_1b3b639e8910d9af) }
