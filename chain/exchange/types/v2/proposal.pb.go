...
// source: liquent/exchange/v2/proposal.proto
...
type SpotMarketParamUpdateProposal struct {
	...
	Status              MarketStatus                 `protobuf:"varint,9,opt,name=status,proto3,enum=liquent.exchange.v2.MarketStatus" json:"status,omitempty"`
...
type ExchangeEnableProposal struct {
	Title        string       `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description  string       `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	ExchangeType ExchangeType `protobuf:"varint,3,opt,name=exchangeType,proto3,enum=liquent.exchange.v2.ExchangeType" json:"exchangeType,omitempty"`
}
...
type DerivativeMarketParamUpdateProposal struct {
	...
	Status               MarketStatus                 `protobuf:"varint,13,opt,name=status,proto3,enum=liquent.exchange.v2.MarketStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("liquent.exchange.v2.ExchangeType", ExchangeType_name, ExchangeType_value)
	proto.RegisterType((*SpotMarketParamUpdateProposal)(nil), "liquent.exchange.v2.SpotMarketParamUpdateProposal")
	proto.RegisterType((*ExchangeEnableProposal)(nil), "liquent.exchange.v2.ExchangeEnableProposal")
	proto.RegisterType((*BatchExchangeModificationProposal)(nil), "liquent.exchange.v2.BatchExchangeModificationProposal")
	proto.RegisterType((*SpotMarketLaunchProposal)(nil), "liquent.exchange.v2.SpotMarketLaunchProposal")
	proto.RegisterType((*PerpetualMarketLaunchProposal)(nil), "liquent.exchange.v2.PerpetualMarketLaunchProposal")
	proto.RegisterType((*BinaryOptionsMarketLaunchProposal)(nil), "liquent.exchange.v2.BinaryOptionsMarketLaunchProposal")
	proto.RegisterType((*ExpiryFuturesMarketLaunchProposal)(nil), "liquent.exchange.v2.ExpiryFuturesMarketLaunchProposal")
	proto.RegisterType((*DerivativeMarketParamUpdateProposal)(nil), "liquent.exchange.v2.DerivativeMarketParamUpdateProposal")
	proto.RegisterType((*AdminInfo)(nil), "liquent.exchange.v2.AdminInfo")
	proto.RegisterType((*MarketForcedSettlementProposal)(nil), "liquent.exchange.v2.MarketForcedSettlementProposal")
	proto.RegisterType((*UpdateDenomDecimalsProposal)(nil), "liquent.exchange.v2.UpdateDenomDecimalsProposal")
	proto.RegisterType((*BinaryOptionsMarketParamUpdateProposal)(nil), "liquent.exchange.v2.BinaryOptionsMarketParamUpdateProposal")
	proto.RegisterType((*ProviderOracleParams)(nil), "liquent.exchange.v2.ProviderOracleParams")
	proto.RegisterType((*OracleParams)(nil), "liquent.exchange.v2.OracleParams")
	proto.RegisterType((*TradingRewardCampaignLaunchProposal)(nil), "liquent.exchange.v2.TradingRewardCampaignLaunchProposal")
	proto.RegisterType((*TradingRewardCampaignUpdateProposal)(nil), "liquent.exchange.v2.TradingRewardCampaignUpdateProposal")
	proto.RegisterType((*RewardPointUpdate)(nil), "liquent.exchange.v2.RewardPointUpdate")
	proto.RegisterType((*TradingRewardPendingPointsUpdateProposal)(nil), "liquent.exchange.v2.TradingRewardPendingPointsUpdateProposal")
	proto.RegisterType((*FeeDiscountProposal)(nil), "liquent.exchange.v2.FeeDiscountProposal")
	proto.RegisterType((*BatchCommunityPoolSpendProposal)(nil), "liquent.exchange.v2.BatchCommunityPoolSpendProposal")
	proto.RegisterType((*AtomicMarketOrderFeeMultiplierScheduleProposal)(nil), "liquent.exchange.v2.AtomicMarketOrderFeeMultiplierScheduleProposal")
	proto.RegisterType((*DenomMinNotionalProposal)(nil), "liquent.exchange.v2.DenomMinNotionalProposal")
}

func init() {
	proto.RegisterFile("liquent/exchange/v2/proposal.proto", fileDescriptor_0fb550654abc72c5)
}
