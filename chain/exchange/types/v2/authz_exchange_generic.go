...
var MsgTypeURLs = map[MsgType]string{
	MsgTypeDeposit:                          "/liquent.exchange.v2.MsgDeposit",
	MsgTypeWithdraw:                         "/liquent.exchange.v2.MsgWithdraw",
	MsgTypeSubaccountTransfer:               "/liquent.exchange.v2.MsgSubaccountTransfer",
	MsgTypeExternalTransfer:                 "/liquent.exchange.v2.MsgExternalTransfer",
	MsgTypeIncreasePositionMargin:           "/liquent.exchange.v2.MsgIncreasePositionMargin",
	MsgTypeDecreasePositionMargin:           "/liquent.exchange.v2.MsgDecreasePositionMargin",
	MsgTypeBatchUpdateOrders:                "/liquent.exchange.v2.MsgBatchUpdateOrders",
	MsgTypeCreateDerivativeLimitOrder:       "/liquent.exchange.v2.MsgCreateDerivativeLimitOrder",
	MsgTypeBatchCreateDerivativeLimitOrders: "/liquent.exchange.v2.MsgBatchCreateDerivativeLimitOrders",
	MsgTypeCreateDerivativeMarketOrder:      "/liquent.exchange.v2.MsgCreateDerivativeMarketOrder",
	MsgTypeCancelDerivativeOrder:            "/liquent.exchange.v2.MsgCancelDerivativeOrder",
	MsgTypeBatchCancelDerivativeOrders:      "/liquent.exchange.v2.MsgBatchCancelDerivativeOrders",
	MsgTypeCreateSpotLimitOrder:             "/liquent.exchange.v2.MsgCreateSpotLimitOrder",
	MsgTypeBatchCreateSpotLimitOrders:       "/liquent.exchange.v2.MsgBatchCreateSpotLimitOrders",
	MsgTypeCreateSpotMarketOrder:            "/liquent.exchange.v2.MsgCreateSpotMarketOrder",
	MsgTypeCancelSpotOrder:                  "/liquent.exchange.v2.MsgCancelSpotOrder",
	MsgTypeBatchCancelSpotOrders:            "/liquent.exchange.v2.MsgBatchCancelSpotOrders",
}
