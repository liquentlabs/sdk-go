...
// source: liquent/exchange/v2/market.proto
...
type SpotMarket struct {
	...
	Status MarketStatus `protobuf:"varint,8,opt,name=status,proto3,enum=liquent.exchange.v2.MarketStatus" json:"status,omitempty"`
...
type BinaryOptionsMarket struct {
	...
	// Status of the market
	Status MarketStatus `protobuf:"varint,14,opt,name=status,proto3,enum=liquent.exchange.v2.MarketStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("liquent.exchange.v2.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterType((*MarketFeeMultiplier)(nil), "liquent.exchange.v2.MarketFeeMultiplier")
	proto.RegisterType((*SpotMarket)(nil), "liquent.exchange.v2.SpotMarket")
	proto.RegisterType((*BinaryOptionsMarket)(nil), "liquent.exchange.v2.BinaryOptionsMarket")
	proto.RegisterType((*DerivativeMarket)(nil), "liquent.exchange.v2.DerivativeMarket")
	proto.RegisterType((*DerivativeMarketSettlementInfo)(nil), "liquent.exchange.v2.DerivativeMarketSettlementInfo")
	proto.RegisterType((*MarketVolume)(nil), "liquent.exchange.v2.MarketVolume")
	proto.RegisterType((*VolumeRecord)(nil), "liquent.exchange.v2.VolumeRecord")
	proto.RegisterType((*ExpiryFuturesMarketInfoState)(nil), "liquent.exchange.v2.ExpiryFuturesMarketInfoState")
	proto.RegisterType((*PerpetualMarketFundingState)(nil), "liquent.exchange.v2.PerpetualMarketFundingState")
	proto.RegisterType((*ExpiryFuturesMarketInfo)(nil), "liquent.exchange.v2.ExpiryFuturesMarketInfo")
	proto.RegisterType((*PerpetualMarketInfo)(nil), "liquent.exchange.v2.PerpetualMarketInfo")
	proto.RegisterType((*PerpetualMarketFunding)(nil), "liquent.exchange.v2.PerpetualMarketFunding")
}

func init() {
	proto.RegisterFile("liquent/exchange/v2/market.proto", fileDescriptor_c255fc568a8e9667)
}
