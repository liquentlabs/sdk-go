...
// source: liquent/exchange/v2/events.proto
...
type EventBatchSpotExecution struct {
	...
	ExecutionType ExecutionType `protobuf:"varint,3,opt,name=executionType,proto3,enum=liquent.exchange.v2.ExecutionType" json:"executionType,omitempty"`
...
type EventBatchDerivativeExecution struct {
	...
	ExecutionType     ExecutionType                `protobuf:"varint,5,opt,name=executionType,proto3,enum=liquent.exchange.v2.ExecutionType" json:"executionType,omitempty"`
...
func init() {
	proto.RegisterType((*EventBatchSpotExecution)(nil), "liquent.exchange.v2.EventBatchSpotExecution")
	proto.RegisterType((*EventBatchDerivativeExecution)(nil), "liquent.exchange.v2.EventBatchDerivativeExecution")
	proto.RegisterType((*EventLostFundsFromLiquidation)(nil), "liquent.exchange.v2.EventLostFundsFromLiquidation")
	proto.RegisterType((*EventBatchDerivativePosition)(nil), "liquent.exchange.v2.EventBatchDerivativePosition")
	proto.RegisterType((*EventDerivativeMarketPaused)(nil), "liquent.exchange.v2.EventDerivativeMarketPaused")
	proto.RegisterType((*EventSettledMarketBalance)(nil), "liquent.exchange.v2.EventSettledMarketBalance")
	proto.RegisterType((*EventNotSettledMarketBalance)(nil), "liquent.exchange.v2.EventNotSettledMarketBalance")
	proto.RegisterType((*EventMarketBeyondBankruptcy)(nil), "liquent.exchange.v2.EventMarketBeyondBankruptcy")
	proto.RegisterType((*EventAllPositionsHaircut)(nil), "liquent.exchange.v2.EventAllPositionsHaircut")
	proto.RegisterType((*EventBinaryOptionsMarketUpdate)(nil), "liquent.exchange.v2.EventBinaryOptionsMarketUpdate")
	proto.RegisterType((*EventNewSpotOrders)(nil), "liquent.exchange.v2.EventNewSpotOrders")
	proto.RegisterType((*EventNewDerivativeOrders)(nil), "liquent.exchange.v2.EventNewDerivativeOrders")
	proto.RegisterType((*EventCancelSpotOrder)(nil), "liquent.exchange.v2.EventCancelSpotOrder")
	proto.RegisterType((*EventSpotMarketUpdate)(nil), "liquent.exchange.v2.EventSpotMarketUpdate")
	proto.RegisterType((*EventPerpetualMarketUpdate)(nil), "liquent.exchange.v2.EventPerpetualMarketUpdate")
	proto.RegisterType((*EventExpiryFuturesMarketUpdate)(nil), "liquent.exchange.v2.EventExpiryFuturesMarketUpdate")
	proto.RegisterType((*EventPerpetualMarketFundingUpdate)(nil), "liquent.exchange.v2.EventPerpetualMarketFundingUpdate")
	proto.RegisterType((*EventSubaccountDeposit)(nil), "liquent.exchange.v2.EventSubaccountDeposit")
	proto.RegisterType((*EventSubaccountWithdraw)(nil), "liquent.exchange.v2.EventSubaccountWithdraw")
	proto.RegisterType((*EventSubaccountBalanceTransfer)(nil), "liquent.exchange.v2.EventSubaccountBalanceTransfer")
	proto.RegisterType((*EventBatchDepositUpdate)(nil), "liquent.exchange.v2.EventBatchDepositUpdate")
	proto.RegisterType((*DerivativeMarketOrderCancel)(nil), "liquent.exchange.v2.DerivativeMarketOrderCancel")
	proto.RegisterType((*EventCancelDerivativeOrder)(nil), "liquent.exchange.v2.EventCancelDerivativeOrder")
	proto.RegisterType((*EventFeeDiscountSchedule)(nil), "liquent.exchange.v2.EventFeeDiscountSchedule")
	proto.RegisterType((*EventTradingRewardCampaignUpdate)(nil), "liquent.exchange.v2.EventTradingRewardCampaignUpdate")
	proto.RegisterType((*EventTradingRewardDistribution)(nil), "liquent.exchange.v2.EventTradingRewardDistribution")
	proto.RegisterType((*EventNewConditionalDerivativeOrder)(nil), "liquent.exchange.v2.EventNewConditionalDerivativeOrder")
	proto.RegisterType((*EventCancelConditionalDerivativeOrder)(nil), "liquent.exchange.v2.EventCancelConditionalDerivativeOrder")
	proto.RegisterType((*EventConditionalDerivativeOrderTrigger)(nil), "liquent.exchange.v2.EventConditionalDerivativeOrderTrigger")
	proto.RegisterType((*EventOrderFail)(nil), "liquent.exchange.v2.EventOrderFail")
	proto.RegisterType((*EventAtomicMarketOrderFeeMultipliersUpdated)(nil), "liquent.exchange.v2.EventAtomicMarketOrderFeeMultipliersUpdated")
	proto.RegisterType((*EventOrderbookUpdate)(nil), "liquent.exchange.v2.EventOrderbookUpdate")
	proto.RegisterType((*OrderbookUpdate)(nil), "liquent.exchange.v2.OrderbookUpdate")
	proto.RegisterType((*Orderbook)(nil), "liquent.exchange.v2.Orderbook")
	proto.RegisterType((*EventGrantAuthorizations)(nil), "liquent.exchange.v2.EventGrantAuthorizations")
	proto.RegisterType((*EventGrantActivation)(nil), "liquent.exchange.v2.EventGrantActivation")
	proto.RegisterType((*EventInvalidGrant)(nil), "liquent.exchange.v2.EventInvalidGrant")
	proto.RegisterType((*EventOrderCancelFail)(nil), "liquent.exchange.v2.EventOrderCancelFail")
	proto.RegisterType((*EventDerivativeOrdersV2Migration)(nil), "liquent.exchange.v2.EventDerivativeOrdersV2Migration")
	proto.RegisterType((*DerivativeOrderV2Changes)(nil), "liquent.exchange.v2.DerivativeOrderV2Changes")
	proto.RegisterType((*EventSpotOrdersV2Migration)(nil), "liquent.exchange.v2.EventSpotOrdersV2Migration")
	proto.RegisterType((*EventTriggerConditionalMarketOrderFailed)(nil), "liquent.exchange.v2.EventTriggerConditionalMarketOrderFailed")
	proto.RegisterType((*EventTriggerConditionalLimitOrderFailed)(nil), "liquent.exchange.v2.EventTriggerConditionalLimitOrderFailed")
	proto.RegisterType((*SpotOrderV2Changes)(nil), "liquent.exchange.v2.SpotOrderV2Changes")
	proto.RegisterType((*EventDerivativePositionV2Migration)(nil), "liquent.exchange.v2.EventDerivativePositionV2Migration")
}

func init() {
	proto.RegisterFile("liquent/exchange/v2/events.proto", fileDescriptor_8ac8f3da550fa1c4)
}
