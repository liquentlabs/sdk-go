...
import (
	...
	insurancetypes "github.com/liquentlabs/sdk-go/chain/insurance/types"
	oracletypes "github.com/liquentlabs/sdk-go/chain/oracle/types"
	wasmxtypes "github.com/liquentlabs/sdk-go/chain/wasmx/types"
)
...
type WasmxExecutionKeeper interface {
	LiquentExec(ctx sdk.Context, contractAddress sdk.AccAddress, funds sdk.Coins, msg *wasmxtypes.LiquentExecMsg) ([]byte, error)
}
