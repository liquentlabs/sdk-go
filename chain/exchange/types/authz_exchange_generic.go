...
func (m MsgType) URL() string {
	switch m {
	case MsgTypeDeposit:
		return "/liquent.exchange.v1beta1.MsgDeposit"
	case MsgTypeWithdraw:
		return "/liquent.exchange.v1beta1.MsgWithdraw"
	case MsgTypeSubaccountTransfer:
		return "/liquent.exchange.v1beta1.MsgSubaccountTransfer"
	case MsgTypeExternalTransfer:
		return "/liquent.exchange.v1beta1.MsgExternalTransfer"
	case MsgTypeIncreasePositionMargin:
		return "/liquent.exchange.v1beta1.MsgIncreasePositionMargin"
	case MsgTypeDecreasePositionMargin:
		return "/liquent.exchange.v1beta1.MsgDecreasePositionMargin"
	case MsgTypeBatchUpdateOrders:
		return "/liquent.exchange.v1beta1.MsgBatchUpdateOrders"
	case MsgTypeCreateDerivativeLimitOrder:
		return "/liquent.exchange.v1beta1.MsgCreateDerivativeLimitOrder"
	case MsgTypeBatchCreateDerivativeLimitOrders:
		return "/liquent.exchange.v1beta1.MsgBatchCreateDerivativeLimitOrders"
	case MsgTypeCreateDerivativeMarketOrder:
		return "/liquent.exchange.v1beta1.MsgCreateDerivativeMarketOrder"
	case MsgTypeCancelDerivativeOrder:
		return "/liquent.exchange.v1beta1.MsgCancelDerivativeOrder"
	case MsgTypeBatchCancelDerivativeOrders:
		return "/liquent.exchange.v1beta1.MsgBatchCancelDerivativeOrders"
	case MsgTypeCreateSpotLimitOrder:
		return "/liquent.exchange.v1beta1.MsgCreateSpotLimitOrder"
	case MsgTypeBatchCreateSpotLimitOrders:
		return "/liquent.exchange.v1beta1.MsgBatchCreateSpotLimitOrders"
	case MsgTypeCreateSpotMarketOrder:
		return "/liquent.exchange.v1beta1.MsgCreateSpotMarketOrder"
	case MsgTypeCancelSpotOrder:
		return "/liquent.exchange.v1beta1.MsgCancelSpotOrder"
	case MsgTypeBatchCancelSpotOrders:
		return "/liquent.exchange.v1beta1.MsgBatchCancelSpotOrders"
	}
	return "UNKNOWN"
}
