...
// source: liquent/ocr/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "liquent.ocr.v1beta1.GenesisState")
	proto.RegisterType((*FeedTransmission)(nil), "liquent.ocr.v1beta1.FeedTransmission")
	proto.RegisterType((*FeedEpochAndRound)(nil), "liquent.ocr.v1beta1.FeedEpochAndRound")
	proto.RegisterType((*FeedLatestAggregatorRoundIDs)(nil), "liquent.ocr.v1beta1.FeedLatestAggregatorRoundIDs")
	proto.RegisterType((*RewardPool)(nil), "liquent.ocr.v1beta1.RewardPool")
	proto.RegisterType((*FeedCounts)(nil), "liquent.ocr.v1beta1.FeedCounts")
	proto.RegisterType((*Count)(nil), "liquent.ocr.v1beta1.Count")
	proto.RegisterType((*PendingPayeeship)(nil), "liquent.ocr.v1beta1.PendingPayeeship")
}

func init() {
	proto.RegisterFile("liquent/ocr/v1beta1/genesis.proto", fileDescriptor_918762553ccd204f)
}
