...
import (
	...
	lqtcodec "github.com/liquentlabs/sdk-go/chain/codec"
)
...
func MakeEncodingConfig() EncodingConfig {
	...
	lqtcodec.RegisterInterfaces(encodingConfig.InterfaceRegistry)
	lqtcodec.RegisterLegacyAminoCodec(encodingConfig.Amino)
