...
// source: liquent/txfees/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "liquent.txfees.v1beta1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "liquent.txfees.v1beta1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("liquent/txfees/v1beta1/tx.proto", fileDescriptor_b294b9f8d0e0a6fb) }
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.txfees.v1beta1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.txfees.v1beta1.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "liquent.txfees.v1beta1.Msg",
	...
	Metadata: "liquent/txfees/v1beta1/tx.proto",
}
