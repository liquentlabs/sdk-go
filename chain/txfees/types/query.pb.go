...
// source: liquent/txfees/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*EipBaseFee)(nil), "liquent.txfees.v1beta1.EipBaseFee")
	proto.RegisterType((*QueryParamsRequest)(nil), "liquent.txfees.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "liquent.txfees.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryEipBaseFeeRequest)(nil), "liquent.txfees.v1beta1.QueryEipBaseFeeRequest")
	proto.RegisterType((*QueryEipBaseFeeResponse)(nil), "liquent.txfees.v1beta1.QueryEipBaseFeeResponse")
}

func init() {
	proto.RegisterFile("liquent/txfees/v1beta1/query.proto", fileDescriptor_d95f5619ed216c51)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.txfees.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetEipBaseFee(ctx context.Context, in *QueryEipBaseFeeRequest, opts ...grpc.CallOption) (*QueryEipBaseFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.txfees.v1beta1.Query/GetEipBaseFee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.txfees.v1beta1.Query/Params",
	}
...
func _Query_GetEipBaseFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.txfees.v1beta1.Query/GetEipBaseFee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "liquent.txfees.v1beta1.Query",
	...
	Metadata: "liquent/txfees/v1beta1/query.proto",
}
