...
// source: liquent/txfees/v1beta1/txfees.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "liquent.txfees.v1beta1.Params")
	golang_proto.RegisterType((*Params)(nil), "liquent.txfees.v1beta1.Params")
}

func init() {
	proto.RegisterFile("liquent/txfees/v1beta1/txfees.proto", fileDescriptor_43abc7238d07d36b)
}
func init() {
	golang_proto.RegisterFile("liquent/txfees/v1beta1/txfees.proto", fileDescriptor_43abc7238d07d36b)
}
