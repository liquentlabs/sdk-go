...
// source: liquent/txfees/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "liquent.txfees.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("liquent/txfees/v1beta1/genesis.proto", fileDescriptor_6434836fdedde04f)
}
