...
// source: liquent/evm/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgEthereumTx)(nil), "liquent.evm.v1.MsgEthereumTx")
	proto.RegisterType((*LegacyTx)(nil), "liquent.evm.v1.LegacyTx")
	proto.RegisterType((*AccessListTx)(nil), "liquent.evm.v1.AccessListTx")
	proto.RegisterType((*DynamicFeeTx)(nil), "liquent.evm.v1.DynamicFeeTx")
	proto.RegisterType((*ExtensionOptionsEthereumTx)(nil), "liquent.evm.v1.ExtensionOptionsEthereumTx")
	proto.RegisterType((*MsgEthereumTxResponse)(nil), "liquent.evm.v1.MsgEthereumTxResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "liquent.evm.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "liquent.evm.v1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("liquent/evm/v1/tx.proto", fileDescriptor_7f62438576d4fe29) }
...
func (c *msgClient) EthereumTx(ctx context.Context, in *MsgEthereumTx, opts ...grpc.CallOption) (*MsgEthereumTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.evm.v1.Msg/EthereumTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.evm.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_EthereumTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.evm.v1.Msg/EthereumTx",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.evm.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "liquent.evm.v1.Msg",
	...
	Metadata: "liquent/evm/v1/tx.proto",
}
