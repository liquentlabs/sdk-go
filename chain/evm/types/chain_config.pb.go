...
// source: liquent/evm/v1/chain_config.proto
...
func init() {
	proto.RegisterType((*ChainConfig)(nil), "liquent.evm.v1.ChainConfig")
	proto.RegisterType((*BlobScheduleConfig)(nil), "liquent.evm.v1.BlobScheduleConfig")
	proto.RegisterType((*BlobConfig)(nil), "liquent.evm.v1.BlobConfig")
}

func init() {
	proto.RegisterFile("liquent/evm/v1/chain_config.proto", fileDescriptor_40db39f43bdf71b8)
}
