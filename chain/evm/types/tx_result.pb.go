...
// source: liquent/evm/v1/tx_result.proto
...
func init() {
	proto.RegisterType((*TxResult)(nil), "liquent.evm.v1.TxResult")
}

func init() { proto.RegisterFile("liquent/evm/v1/tx_result.proto", fileDescriptor_6868197df3a51cef) }
