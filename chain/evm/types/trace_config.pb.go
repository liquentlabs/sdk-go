...
// source: liquent/evm/v1/trace_config.proto
...
func init() {
	proto.RegisterType((*TraceConfig)(nil), "liquent.evm.v1.TraceConfig")
}

func init() {
	proto.RegisterFile("liquent/evm/v1/trace_config.proto", fileDescriptor_c7e91cf99012bf9d)
}
