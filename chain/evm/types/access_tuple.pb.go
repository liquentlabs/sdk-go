...
// source: liquent/evm/v1/access_tuple.proto
...
func init() {
	proto.RegisterType((*AccessTuple)(nil), "liquent.evm.v1.AccessTuple")
}

func init() {
	proto.RegisterFile("liquent/evm/v1/access_tuple.proto", fileDescriptor_08f52b3371b9b4eb)
}
