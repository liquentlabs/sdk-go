...
// source: liquent/stream/v1beta1/query.proto
...
import (
	...
	fmt "fmt"
	types "github.com/liquentlabs/sdk-go/chain/exchange/types"
...
type SpotOrderUpdate struct {
	Status    OrderUpdateStatus `protobuf:"varint,1,opt,name=status,proto3,enum=liquent.stream.v1beta1.OrderUpdateStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("liquent.stream.v1beta1.OrderUpdateStatus", OrderUpdateStatus_name, OrderUpdateStatus_value)
	proto.RegisterType((*StreamRequest)(nil), "liquent.stream.v1beta1.StreamRequest")
	proto.RegisterType((*StreamResponse)(nil), "liquent.stream.v1beta1.StreamResponse")
	proto.RegisterType((*OrderbookUpdate)(nil), "liquent.stream.v1beta1.OrderbookUpdate")
	proto.RegisterType((*Orderbook)(nil), "liquent.stream.v1beta1.Orderbook")
	proto.RegisterType((*BankBalance)(nil), "liquent.stream.v1beta1.BankBalance")
	proto.RegisterType((*SubaccountDeposits)(nil), "liquent.stream.v1beta1.SubaccountDeposits")
	proto.RegisterType((*SubaccountDeposit)(nil), "liquent.stream.v1beta1.SubaccountDeposit")
	proto.RegisterType((*SpotOrderUpdate)(nil), "liquent.stream.v1beta1.SpotOrderUpdate")
	proto.RegisterType((*SpotOrder)(nil), "liquent.stream.v1beta1.SpotOrder")
	proto.RegisterType((*DerivativeOrderUpdate)(nil), "liquent.stream.v1beta1.DerivativeOrderUpdate")
	proto.RegisterType((*DerivativeOrder)(nil), "liquent.stream.v1beta1.DerivativeOrder")
	proto.RegisterType((*Position)(nil), "liquent.stream.v1beta1.Position")
	proto.RegisterType((*OraclePrice)(nil), "liquent.stream.v1beta1.OraclePrice")
	proto.RegisterType((*SpotTrade)(nil), "liquent.stream.v1beta1.SpotTrade")
	proto.RegisterType((*DerivativeTrade)(nil), "liquent.stream.v1beta1.DerivativeTrade")
	proto.RegisterType((*TradesFilter)(nil), "liquent.stream.v1beta1.TradesFilter")
	proto.RegisterType((*PositionsFilter)(nil), "liquent.stream.v1beta1.PositionsFilter")
	proto.RegisterType((*OrdersFilter)(nil), "liquent.stream.v1beta1.OrdersFilter")
	proto.RegisterType((*OrderbookFilter)(nil), "liquent.stream.v1beta1.OrderbookFilter")
	proto.RegisterType((*BankBalancesFilter)(nil), "liquent.stream.v1beta1.BankBalancesFilter")
	proto.RegisterType((*SubaccountDepositsFilter)(nil), "liquent.stream.v1beta1.SubaccountDepositsFilter")
	proto.RegisterType((*OraclePriceFilter)(nil), "liquent.stream.v1beta1.OraclePriceFilter")
}

func init() {
	proto.RegisterFile("liquent/stream/v1beta1/query.proto", fileDescriptor_e23b7dcfb2fbc9c7)
}
...
func (c *streamClient) Stream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Stream_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[0], "/liquent.stream.v1beta1.Stream/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
var _Stream_serviceDesc = grpc.ServiceDesc{
	ServiceName: "liquent.stream.v1beta1.Stream",
	...
	Metadata: "liquent/stream/v1beta1/query.proto",
}
