...
// source: liquent/stream/v2/query.proto
...
type SpotOrderUpdate struct {
	...
	Status OrderUpdateStatus `protobuf:"varint,1,opt,name=status,proto3,enum=liquent.stream.v2.OrderUpdateStatus" json:"status,omitempty"`
	// the order hash
...
func init() {
	proto.RegisterEnum("liquent.stream.v2.OrderUpdateStatus", OrderUpdateStatus_name, OrderUpdateStatus_value)
	proto.RegisterType((*StreamRequest)(nil), "liquent.stream.v2.StreamRequest")
	proto.RegisterType((*StreamResponse)(nil), "liquent.stream.v2.StreamResponse")
	proto.RegisterType((*OrderbookUpdate)(nil), "liquent.stream.v2.OrderbookUpdate")
	proto.RegisterType((*Orderbook)(nil), "liquent.stream.v2.Orderbook")
	proto.RegisterType((*BankBalance)(nil), "liquent.stream.v2.BankBalance")
	proto.RegisterType((*SubaccountDeposits)(nil), "liquent.stream.v2.SubaccountDeposits")
	proto.RegisterType((*SubaccountDeposit)(nil), "liquent.stream.v2.SubaccountDeposit")
	proto.RegisterType((*SpotOrderUpdate)(nil), "liquent.stream.v2.SpotOrderUpdate")
	proto.RegisterType((*SpotOrder)(nil), "liquent.stream.v2.SpotOrder")
	proto.RegisterType((*DerivativeOrderUpdate)(nil), "liquent.stream.v2.DerivativeOrderUpdate")
	proto.RegisterType((*DerivativeOrder)(nil), "liquent.stream.v2.DerivativeOrder")
	proto.RegisterType((*Position)(nil), "liquent.stream.v2.Position")
	proto.RegisterType((*OraclePrice)(nil), "liquent.stream.v2.OraclePrice")
	proto.RegisterType((*SpotTrade)(nil), "liquent.stream.v2.SpotTrade")
	proto.RegisterType((*DerivativeTrade)(nil), "liquent.stream.v2.DerivativeTrade")
	proto.RegisterType((*TradesFilter)(nil), "liquent.stream.v2.TradesFilter")
	proto.RegisterType((*PositionsFilter)(nil), "liquent.stream.v2.PositionsFilter")
	proto.RegisterType((*OrdersFilter)(nil), "liquent.stream.v2.OrdersFilter")
	proto.RegisterType((*OrderbookFilter)(nil), "liquent.stream.v2.OrderbookFilter")
	proto.RegisterType((*BankBalancesFilter)(nil), "liquent.stream.v2.BankBalancesFilter")
	proto.RegisterType((*SubaccountDepositsFilter)(nil), "liquent.stream.v2.SubaccountDepositsFilter")
	proto.RegisterType((*OraclePriceFilter)(nil), "liquent.stream.v2.OraclePriceFilter")
}

func init() { proto.RegisterFile("liquent/stream/v2/query.proto", fileDescriptor_63d15adfde4eb6f9) }
...
func (c *streamClient) StreamV2(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Stream_StreamV2Client, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[0], "/liquent.stream.v2.Stream/StreamV2", opts...)
	if err != nil {
		return nil, err
	}
...
var _Stream_serviceDesc = grpc.ServiceDesc{
	ServiceName: "liquent.stream.v2.Stream",
	...
	Metadata: "liquent/stream/v2/query.proto",
}
