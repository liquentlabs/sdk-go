...
// source: liquent/wasmx/v1/events.proto
...
func init() {
	proto.RegisterType((*EventContractExecution)(nil), "liquent.wasmx.v1.EventContractExecution")
	proto.RegisterType((*EventContractRegistered)(nil), "liquent.wasmx.v1.EventContractRegistered")
	proto.RegisterType((*EventContractDeregistered)(nil), "liquent.wasmx.v1.EventContractDeregistered")
}

func init() { proto.RegisterFile("liquent/wasmx/v1/events.proto", fileDescriptor_f2ba06c5f04cb490) }
