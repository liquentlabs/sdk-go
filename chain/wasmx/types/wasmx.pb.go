...
// source: liquent/wasmx/v1/wasmx.proto
...
type RegisteredContract struct {
	...
	// funding mode
	FundMode FundingMode `protobuf:"varint,7,opt,name=fund_mode,json=fundMode,proto3,enum=liquent.wasmx.v1.FundingMode" json:"fund_mode,omitempty"`
}
...
func init() {
	proto.RegisterType((*Params)(nil), "liquent.wasmx.v1.Params")
	proto.RegisterType((*RegisteredContract)(nil), "liquent.wasmx.v1.RegisteredContract")
}

func init() { proto.RegisterFile("liquent/wasmx/v1/wasmx.proto", fileDescriptor_6818ff331f2cddc4) }
