...
// source: liquent/erc20/v1beta1/erc20.proto
...
func init() {
	proto.RegisterType((*TokenPair)(nil), "liquent.erc20.v1beta1.TokenPair")
}

func init() {
	proto.RegisterFile("liquent/erc20/v1beta1/erc20.proto", fileDescriptor_a54415e94b67e1cf)
}
