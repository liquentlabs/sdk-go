...
// source: liquent/auction/v1beta1/tx.proto
...
type MsgBid struct {
	...
	// amount of the bid in LQT tokens
...
func init() {
	proto.RegisterType((*MsgBid)(nil), "liquent.auction.v1beta1.MsgBid")
	proto.RegisterType((*MsgBidResponse)(nil), "liquent.auction.v1beta1.MsgBidResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "liquent.auction.v1beta1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "liquent.auction.v1beta1.MsgUpdateParamsResponse")
}

func init() {
	proto.RegisterFile("liquent/auction/v1beta1/tx.proto", fileDescriptor_0943fd5f0d415547)
}
...
func (c *msgClient) Bid(ctx context.Context, in *MsgBid, opts ...grpc.CallOption) (*MsgBidResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.auction.v1beta1.Msg/Bid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/liquent.auction.v1beta1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Bid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.auction.v1beta1.Msg/Bid",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liquent.auction.v1beta1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "liquent.auction.v1beta1.Msg",
	...
	Metadata: "liquent/auction/v1beta1/tx.proto",
}
