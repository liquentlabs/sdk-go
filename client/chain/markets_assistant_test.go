...
func TestMarketAssistantCreation(t *testing.T) {
	tokensList := []core.TokenMetadata{
		...
		},
		{
			...
			Logo:              "https://imagedelivery.net/lPzngbR8EltRfBOi_WYaXw/6f015260-c589-499f-b692-a57964af9900/public",
			CoinGeckoId:       "",
			Address:           "factory/lqt10vkkttgxdeqcgeppu20x9qtyvuaxxev8qh0awq/usdt",
			Denom:             "factory/lqt10vkkttgxdeqcgeppu20x9qtyvuaxxev8qh0awq/usdt",
			ExternalLogo:      "unknown.png",
		...
		},
		{
			...
			CoinGeckoId:       "liquent-protocol",
			Denom:             "lqt",
			TokenType:         "native",
			ExternalLogo:      "liquent-v3.png",
		},
		{
			Decimals:          6,
			Symbol:            "USDTPERP",
	...
	lqtUsdtSpotMarketInfo := createLQTUSDTChainSpotMarketV1()
	...
	spotMarketInfos = append(spotMarketInfos, lqtUsdtSpotMarketInfo)
	...
	symbols := strings.Split(lqtUsdtSpotMarketInfo.Ticker, "/")
	lqtSymbol, usdtSymbol := symbols[0], symbols[1]
	...
	_, isPresent = spotMarkets[lqtUsdtSpotMarketInfo.MarketId]
	assert.True(t, isPresent)
...
func TestHumanReadableMarketAssistantCreation(t *testing.T) {
	...
	lqtUsdtSpotMarketInfo := createLQTUSDTChainSpotMarketV2()
