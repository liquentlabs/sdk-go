...
import (
	...
	auction "github.com/liquentlabs/sdk-go/chain/auction/types"
	keyscodec "github.com/liquentlabs/sdk-go/chain/crypto/codec"
	erc20types "github.com/liquentlabs/sdk-go/chain/erc20/types"
	evmtypes "github.com/liquentlabs/sdk-go/chain/evm/types"
	exchange "github.com/liquentlabs/sdk-go/chain/exchange/types"
	exchangev2 "github.com/liquentlabs/sdk-go/chain/exchange/types/v2"
	insurance "github.com/liquentlabs/sdk-go/chain/insurance/types"
	ocr "github.com/liquentlabs/sdk-go/chain/ocr/types"
	oracle "github.com/liquentlabs/sdk-go/chain/oracle/types"
	peggy "github.com/liquentlabs/sdk-go/chain/peggy/types"
	permissions "github.com/liquentlabs/sdk-go/chain/permissions/types"
	tokenfactory "github.com/liquentlabs/sdk-go/chain/tokenfactory/types"
	txfeestypes "github.com/liquentlabs/sdk-go/chain/txfees/types"
	chaintypes "github.com/liquentlabs/sdk-go/chain/types"
	wasmx "github.com/liquentlabs/sdk-go/chain/wasmx/types"
)
...
func NewTxConfig(signModes []signingtypes.SignMode) client.TxConfig {
	marshaler, _ := createLiquentProtoCodec()
...
func NewClientContext(
	...
	marshaler, interfaceRegistry := createLiquentProtoCodec()
...
func createLiquentProtoCodec() (liquentCodec *codec.ProtoCodec, interfaceRegistry types.InterfaceRegistry) {
	...
	liquentCodec = codec.NewProtoCodec(interfaceRegistry)

	return liquentCodec, interfaceRegistry
}
