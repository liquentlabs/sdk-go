...
import (
	...
	oracletypes "github.com/liquentlabs/sdk-go/chain/oracle/types"
)

func createSmartDenomMetadata() types.Metadata {
	firstDenomUnit := types.DenomUnit{
		Denom:    "factory/lqt105ujajd95znwjvcy3hwcz80pgy8tc6v77spur0/SMART",
		Exponent: 0,
	...
	metadata := types.Metadata{
		...
		Base:        "factory/lqt105ujajd95znwjvcy3hwcz80pgy8tc6v77spur0/SMART",
		Display:     "SMART",
		Name:        "SMART",
		Symbol:      "SMART",
...
func createLQTUSDTChainSpotMarketV1() *exchangev1types.SpotMarket {
...
func createAPEUSDTChainSpotMarketV1() *exchangev1types.SpotMarket {
	marketInfo := exchangev1types.SpotMarket{
		...
		QuoteDenom:          "factory/lqt10vkkttgxdeqcgeppu20x9qtyvuaxxev8qh0awq/usdt",
		MakerFeeRate:        math.LegacyMustNewDecFromStr("-0.0001"),
		TakerFeeRate:        math.LegacyMustNewDecFromStr("0.001"),
		RelayerFeeShareRate: math.LegacyMustNewDecFromStr("0.4"),
...
func createFirstMatchBetBinaryOptionsMarketV1() *exchangev1types.BinaryOptionsMarket {
	market := exchangev1types.BinaryOptionsMarket{
		...
		Admin:               "lqt1zlh5sqevkfphtwnu9cul8p89vseme2eqt0snn9",
		QuoteDenom:          "peggy0x87aB3B4C8661e07D6372361211B96ed4Dc36B1B5",
...
func createLQTUSDTChainSpotMarketV2() *exchangev2types.SpotMarket {
