...
func (e *MockExchangeClient) StreamDerivativeOrderbookV2(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrderbookV2Client, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamDerivativeOrderbookUpdate(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrderbookUpdateClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamDerivativeMarket(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamMarketClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamDerivativePositions(ctx context.Context, req *derivativeExchangePB.StreamPositionsRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamPositionsClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamDerivativePositionsV2(ctx context.Context, req *derivativeExchangePB.StreamPositionsV2Request) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamPositionsV2Client, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamDerivativeOrders(ctx context.Context, req *derivativeExchangePB.StreamOrdersRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrdersClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamDerivativeTrades(ctx context.Context, req *derivativeExchangePB.StreamTradesRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamTradesClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamDerivativeV2Trades(ctx context.Context, req *derivativeExchangePB.StreamTradesV2Request) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamTradesV2Client, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamHistoricalDerivativeOrders(ctx context.Context, req *derivativeExchangePB.StreamOrdersHistoryRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrdersHistoryClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamPrices(ctx context.Context, baseSymbol, quoteSymbol, oracleType string) (oraclePB.LiquentOracleRPC_StreamPricesClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamBids(ctx context.Context) (auctionPB.LiquentAuctionRPC_StreamBidsClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) FetchLqtBurnt(ctx context.Context) (*auctionPB.LqtBurntEndpointResponse, error) {
	return &auctionPB.LqtBurntEndpointResponse{}, nil
}
...
func (e *MockExchangeClient) StreamSubaccountBalance(ctx context.Context, subaccountId string) (accountPB.LiquentAccountsRPC_StreamSubaccountBalanceClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamSpotOrderbookV2(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrderbookV2Client, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamSpotOrderbookUpdate(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrderbookUpdateClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamSpotMarket(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamMarketsClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamSpotOrders(ctx context.Context, req *spotExchangePB.StreamOrdersRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrdersClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamSpotTrades(ctx context.Context, req *spotExchangePB.StreamTradesRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamTradesClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamSpotTradesV2(ctx context.Context, req *spotExchangePB.StreamTradesV2Request) (spotExchangePB.LiquentSpotExchangeRPC_StreamTradesV2Client, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamHistoricalSpotOrders(ctx context.Context, req *spotExchangePB.StreamOrdersHistoryRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrdersHistoryClient, error) {
	return nil, nil
}
...
func (e *MockExchangeClient) StreamAccountPortfolio(ctx context.Context, accountAddress, subaccountId, balanceType string) (portfolioExchangePB.LiquentPortfolioRPC_StreamAccountPortfolioClient, error) {
	return nil, nil
}

func (e *MockExchangeClient) StreamKeepalive(ctx context.Context) (metaPB.LiquentMetaRPC_StreamKeepaliveClient, error) {
	return nil, nil
}
