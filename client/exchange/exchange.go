...
import (
	...
	accountPB "github.com/liquentlabs/sdk-go/exchange/accounts_rpc/pb"
	auctionPB "github.com/liquentlabs/sdk-go/exchange/auction_rpc/pb"
	derivativeExchangePB "github.com/liquentlabs/sdk-go/exchange/derivative_exchange_rpc/pb"
	insurancePB "github.com/liquentlabs/sdk-go/exchange/insurance_rpc/pb"
	metaPB "github.com/liquentlabs/sdk-go/exchange/meta_rpc/pb"
	oraclePB "github.com/liquentlabs/sdk-go/exchange/oracle_rpc/pb"
	portfolioExchangePB "github.com/liquentlabs/sdk-go/exchange/portfolio_rpc/pb"
	spotExchangePB "github.com/liquentlabs/sdk-go/exchange/spot_exchange_rpc/pb"
	log "github.com/liquentlabs/suplog"
...
type ExchangeClient interface {
	...
	StreamDerivativeOrderbookV2(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrderbookV2Client, error)
	StreamDerivativeOrderbookUpdate(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrderbookUpdateClient, error)
	StreamDerivativeMarket(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamMarketClient, error)
	...
	StreamDerivativePositions(ctx context.Context, req *derivativeExchangePB.StreamPositionsRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamPositionsClient, error)
	StreamDerivativePositionsV2(ctx context.Context, req *derivativeExchangePB.StreamPositionsV2Request) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamPositionsV2Client, error)
	StreamDerivativeOrders(ctx context.Context, req *derivativeExchangePB.StreamOrdersRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrdersClient, error)
	...
	StreamDerivativeTrades(ctx context.Context, req *derivativeExchangePB.StreamTradesRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamTradesClient, error)
	StreamDerivativeV2Trades(ctx context.Context, req *derivativeExchangePB.StreamTradesV2Request) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamTradesV2Client, error)
	...
	StreamHistoricalDerivativeOrders(ctx context.Context, req *derivativeExchangePB.StreamOrdersHistoryRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrdersHistoryClient, error)
	...
	StreamPrices(ctx context.Context, baseSymbol string, quoteSymbol string, oracleType string) (oraclePB.LiquentOracleRPC_StreamPricesClient, error)
	...
	StreamBids(ctx context.Context) (auctionPB.LiquentAuctionRPC_StreamBidsClient, error)
	FetchLqtBurnt(ctx context.Context) (*auctionPB.LqtBurntEndpointResponse, error)
	...
	StreamSubaccountBalance(ctx context.Context, subaccountId string) (accountPB.LiquentAccountsRPC_StreamSubaccountBalanceClient, error)
	...
	StreamSpotOrderbookV2(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrderbookV2Client, error)
	StreamSpotOrderbookUpdate(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrderbookUpdateClient, error)
	...
	StreamSpotMarket(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamMarketsClient, error)
	StreamSpotOrders(ctx context.Context, req *spotExchangePB.StreamOrdersRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrdersClient, error)
	...
	StreamSpotTrades(ctx context.Context, req *spotExchangePB.StreamTradesRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamTradesClient, error)
	StreamSpotTradesV2(ctx context.Context, req *spotExchangePB.StreamTradesV2Request) (spotExchangePB.LiquentSpotExchangeRPC_StreamTradesV2Client, error)
	...
	StreamHistoricalSpotOrders(ctx context.Context, req *spotExchangePB.StreamOrdersHistoryRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrdersHistoryClient, error)
	...
	StreamAccountPortfolio(ctx context.Context, accountAddress string, subaccountId, balanceType string) (portfolioExchangePB.LiquentPortfolioRPC_StreamAccountPortfolioClient, error)
	FetchOpenInterest(ctx context.Context, marketIDs []string) (*derivativeExchangePB.OpenInterestResponse, error)

	StreamKeepalive(ctx context.Context) (metaPB.LiquentMetaRPC_StreamKeepaliveClient, error)
...
func NewExchangeClient(network common.Network, options ...common.ClientOption) (ExchangeClient, error) {
	...
	cc := &exchangeClient{
		...
		metaClient:               metaPB.NewLiquentMetaRPCClient(conn),
		accountClient:            accountPB.NewLiquentAccountsRPCClient(conn),
		auctionClient:            auctionPB.NewLiquentAuctionRPCClient(conn),
		oracleClient:             oraclePB.NewLiquentOracleRPCClient(conn),
		insuranceClient:          insurancePB.NewLiquentInsuranceRPCClient(conn),
		spotExchangeClient:       spotExchangePB.NewLiquentSpotExchangeRPCClient(conn),
		derivativeExchangeClient: derivativeExchangePB.NewLiquentDerivativeExchangeRPCClient(conn),
		portfolioExchangeClient:  portfolioExchangePB.NewLiquentPortfolioRPCClient(conn),
...
type exchangeClient struct {
	...
	metaClient               metaPB.LiquentMetaRPCClient
	accountClient            accountPB.LiquentAccountsRPCClient
	auctionClient            auctionPB.LiquentAuctionRPCClient
	oracleClient             oraclePB.LiquentOracleRPCClient
	insuranceClient          insurancePB.LiquentInsuranceRPCClient
	spotExchangeClient       spotExchangePB.LiquentSpotExchangeRPCClient
	derivativeExchangeClient derivativeExchangePB.LiquentDerivativeExchangeRPCClient
	portfolioExchangeClient  portfolioExchangePB.LiquentPortfolioRPCClient
}
...
func (c *exchangeClient) StreamDerivativeOrderbookV2(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrderbookV2Client, error) {
...
func (c *exchangeClient) StreamDerivativeOrderbookUpdate(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrderbookUpdateClient, error) {
...
func (c *exchangeClient) StreamDerivativeMarket(ctx context.Context, marketIDs []string) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamMarketClient, error) {
...
// Deprecated: Use StreamDerivativePositionsV2 instead. This method will be removed in a future version.
func (c *exchangeClient) StreamDerivativePositions(ctx context.Context, req *derivativeExchangePB.StreamPositionsRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamPositionsClient, error) {
...
func (c *exchangeClient) StreamDerivativePositionsV2(ctx context.Context, req *derivativeExchangePB.StreamPositionsV2Request) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamPositionsV2Client, error) {
...
func (c *exchangeClient) StreamDerivativeOrders(ctx context.Context, req *derivativeExchangePB.StreamOrdersRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrdersClient, error) {
...
func (c *exchangeClient) StreamDerivativeTrades(ctx context.Context, req *derivativeExchangePB.StreamTradesRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamTradesClient, error) {
...
func (c *exchangeClient) StreamDerivativeV2Trades(ctx context.Context, req *derivativeExchangePB.StreamTradesV2Request) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamTradesV2Client, error) {
...
func (c *exchangeClient) StreamHistoricalDerivativeOrders(ctx context.Context, req *derivativeExchangePB.StreamOrdersHistoryRequest) (derivativeExchangePB.LiquentDerivativeExchangeRPC_StreamOrdersHistoryClient, error) {
...
func (c *exchangeClient) StreamPrices(ctx context.Context, baseSymbol, quoteSymbol, oracleType string) (oraclePB.LiquentOracleRPC_StreamPricesClient, error) {
...
func (c *exchangeClient) StreamBids(ctx context.Context) (auctionPB.LiquentAuctionRPC_StreamBidsClient, error) {
...
func (c *exchangeClient) FetchLqtBurnt(ctx context.Context) (*auctionPB.LqtBurntEndpointResponse, error) {
	req := auctionPB.LqtBurntEndpointRequest{}

	res, err := common.ExecuteCall(ctx, c.network.ExchangeCookieAssistant, c.auctionClient.LqtBurntEndpoint, &req)
	if err != nil {
		fmt.Println(err)
		return &auctionPB.LqtBurntEndpointResponse{}, err
	}
...
func (c *exchangeClient) StreamSubaccountBalance(ctx context.Context, subaccountId string) (accountPB.LiquentAccountsRPC_StreamSubaccountBalanceClient, error) {
...
func (c *exchangeClient) StreamSpotOrderbookUpdate(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrderbookUpdateClient, error) {
...
func (c *exchangeClient) StreamSpotOrderbookV2(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrderbookV2Client, error) {
...
func (c *exchangeClient) StreamSpotMarket(ctx context.Context, marketIDs []string) (spotExchangePB.LiquentSpotExchangeRPC_StreamMarketsClient, error) {
...
func (c *exchangeClient) StreamSpotOrders(ctx context.Context, req *spotExchangePB.StreamOrdersRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrdersClient, error) {
...
func (c *exchangeClient) StreamSpotTrades(ctx context.Context, req *spotExchangePB.StreamTradesRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamTradesClient, error) {
...
func (c *exchangeClient) StreamSpotTradesV2(ctx context.Context, req *spotExchangePB.StreamTradesV2Request) (spotExchangePB.LiquentSpotExchangeRPC_StreamTradesV2Client, error) {
...
func (c *exchangeClient) StreamHistoricalSpotOrders(ctx context.Context, req *spotExchangePB.StreamOrdersHistoryRequest) (spotExchangePB.LiquentSpotExchangeRPC_StreamOrdersHistoryClient, error) {
...
func (c *exchangeClient) StreamKeepalive(ctx context.Context) (metaPB.LiquentMetaRPC_StreamKeepaliveClient, error) {
...
func (c *exchangeClient) StreamAccountPortfolio(ctx context.Context, accountAddress, subaccountId, balanceType string) (portfolioExchangePB.LiquentPortfolioRPC_StreamAccountPortfolioClient, error) {
