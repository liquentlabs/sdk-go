...
type ExplorerClient interface {
	...
	StreamTxs(ctx context.Context) (explorerpb.LiquentExplorerRPC_StreamTxsClient, error)
	StreamBlocks(ctx context.Context) (explorerpb.LiquentExplorerRPC_StreamBlocksClient, error)
	Close()
}
...
func NewExplorerClient(network common.Network, options ...common.ClientOption) (ExplorerClient, error) {
	...
	cc := &explorerClient{
		...
		explorerClient: explorerpb.NewLiquentExplorerRPCClient(conn),
...
type explorerClient struct {
	...
	explorerClient explorerpb.LiquentExplorerRPCClient
}
...
func (c *explorerClient) StreamTxs(ctx context.Context) (explorerpb.LiquentExplorerRPC_StreamTxsClient, error) {
...
func (c *explorerClient) StreamBlocks(ctx context.Context) (explorerpb.LiquentExplorerRPC_StreamBlocksClient, error) {
