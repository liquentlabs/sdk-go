...
const (
	...
	MainnetTokensListURL = "https://github.com/liquentlabs/liquent-lists/raw/master/tokens/mainnet.json"
	// nolint:gosec // not credentials, just the link to the public tokens list
	TestnetTokensListURL = "https://github.com/liquentlabs/liquent-lists/raw/master/tokens/testnet.json"
	// nolint:gosec // not credentials, just the link to the public tokens list
	DevnetTokensListURL = "https://github.com/liquentlabs/liquent-lists/raw/master/tokens/devnet.json"
)
...
func LoadNetwork(name, node string) Network {
	...
	case "devnet-1":
		return Network{
			LcdEndpoint:             "https://devnet-1.lcd.liquent.dev",
			TmEndpoint:              "https://devnet-1.tm.liquent.dev:443",
			ChainGrpcEndpoint:       "devnet-1.grpc.liquent.dev:9900",
			ChainStreamGrpcEndpoint: "devnet-1.grpc.liquent.dev:9999",
			ExchangeGrpcEndpoint:    "devnet-1.api.liquent.dev:9910",
			ExplorerGrpcEndpoint:    "devnet-1.api.liquent.dev:9911",
			ChainId:                 "liquent-777",
			FeeDenom:                "lqt",
			Name:                    "devnet-1",
			ChainCookieAssistant:    &DisabledCookieAssistant{},
	...
	case "devnet":
		return Network{
			LcdEndpoint:             "https://devnet.lcd.liquent.dev",
			TmEndpoint:              "https://devnet.tm.liquent.dev:443",
			ChainGrpcEndpoint:       "devnet.liquent.dev:9900",
			ChainStreamGrpcEndpoint: "devnet.liquent.dev:9999",
			ExchangeGrpcEndpoint:    "devnet.liquent.dev:9910",
			ExplorerGrpcEndpoint:    "devnet.api.liquent.dev:9911",
			ChainId:                 "liquent-777",
			FeeDenom:                "lqt",
			Name:                    "devnet",
			ChainCookieAssistant:    &DisabledCookieAssistant{},
	...
	case "testnet":
		...
		if node == "lb" {
			lcdEndpoint = "https://testnet.sentry.lcd.liquent.network:443"
			tmEndpoint = "https://testnet.sentry.tm.liquent.network:443"
			chainGrpcEndpoint = "testnet.sentry.chain.grpc.liquent.network:443"
			chainStreamGrpcEndpoint = "testnet.sentry.chain.stream.liquent.network:443"
			exchangeGrpcEndpoint = "testnet.sentry.exchange.grpc.liquent.network:443"
			explorerGrpcEndpoint = "testnet.sentry.explorer.grpc.liquent.network:443"
			...
			lcdEndpoint = "https://testnet.lcd.liquent.network:443"
			tmEndpoint = "https://testnet.tm.liquent.network:443"
			chainGrpcEndpoint = "testnet.chain.grpc.liquent.network:443"
			chainStreamGrpcEndpoint = "testnet.chain.stream.liquent.network:443"
			exchangeGrpcEndpoint = "testnet.exchange.grpc.liquent.network:443"
			explorerGrpcEndpoint = "testnet.explorer.grpc.liquent.network:443"
			chainTLSCert = credentials.NewServerTLSFromCert(&tls.Certificate{})
			exchangeTLSCert = credentials.NewServerTLSFromCert(&tls.Certificate{})
			explorerTLSCert = credentials.NewServerTLSFromCert(&tls.Certificate{})
			chainCookieAssistant = &DisabledCookieAssistant{}
	...
	case "mainnet":
		...
		lcdEndpoint = "https://sentry.lcd.liquent.network"
		tmEndpoint = "https://sentry.tm.liquent.network:443"
		chainGrpcEndpoint = "sentry.chain.grpc.liquent.network:443"
		chainStreamGrpcEndpoint = "sentry.chain.stream.liquent.network:443"
		exchangeGrpcEndpoint = "sentry.exchange.grpc.liquent.network:443"
		explorerGrpcEndpoint = "sentry.explorer.grpc.liquent.network:443"
		chainTLSCert = credentials.NewServerTLSFromCert(&tls.Certificate{})
		exchangeTLSCert = credentials.NewServerTLSFromCert(&tls.Certificate{})
		explorerTLSCert = credentials.NewServerTLSFromCert(&tls.Certificate{})
		chainCookieAssistant = &BareMetalLoadBalancedCookieAssistant{}
