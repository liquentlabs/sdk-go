...
* `WithKeyringAppName` option sets keyring application name (defaults to `liquentd`)
...
> liquentd keys --keyring-dir `pwd` --keyring-backend file add test
```
